  ...
  return (
    <div className="rounded-lg mb-3 overflow-hidden w-full text-lg">
      {content.map((row, index) => (
        <div key={index} className={`group flex hover:bg-orange-500 dark:hover:bg-orange-500 hover:text-white ` + (index % 2 === 0 ? "bg-zinc-100 dark:bg-zinc-600" : "bg-zinc-200 dark:bg-zinc-700")}>
